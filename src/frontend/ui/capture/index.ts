...
export class Capture extends KojiBridge {
  ...
  /**
   * Prompts the user to select a color, either from a swatch or by entering a color code. Supports HEX, RGB, or HSL by default, and RBGA or HSLA, if transparency is enabled.
   *
   * @param   options
