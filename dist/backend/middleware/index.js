...
var decodeObject = function decodeObject(obj) {
  Object.keys(obj).forEach(function (key) {
    ...
    if (obj[key] && typeof obj[key] !== 'boolean' && typeof obj[key] !== 'number') {
...
function middleware() {
  ...
  return function kojiMiddleware(req, res, next) {
    ...
    var _kojiConfig$remixData = kojiConfig.remixData,
        remixData = _kojiConfig$remixData === void 0 ? {} : _kojiConfig$remixData; // Apply version-specific overrides (equivalent of window.KOJI_OVERRIDES.overrides on the client)
